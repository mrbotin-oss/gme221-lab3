...
# Normalize dataset road for MultiLineString features
...
# Quick test for debugging and conceptual clarity
all_sample_points = []
...
# Sample elevation value from DEM
band1 = dem.read(1)
nodata = dem.nodata
